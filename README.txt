...
OpenCV 3.4.3 is required
	...
	Go to https://opencv.org/releases.html for download
	unzip the downloaded folder in the Downloads directory
	create a build folder in your workplace directory
	in the terminal:
	cd to the folder
	cmake /home/pi/Downloads/opencv-3.4.3
	make
	sudo make install
